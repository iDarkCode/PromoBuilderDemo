...
namespace PromoEngine.Application
{
 ...
 public interface IRuleEngineService{ Task<bool> EvaluateAsync(Workflow wf,string ruleName,object ctx,CancellationToken ct); }
 ...
 public interface IPromotionCompiler{ (Workflow Workflow, List<string> Warnings) BuildWorkflow(UpsertPromotionDraftRequest req,IReadOnlyDictionary<Guid,AttributeCatalog> attrs,IReadOnlyDictionary<Guid,OperatorCatalog> ops,IReadOnlySet<(Guid operatorId, DataType type)> supported); }
